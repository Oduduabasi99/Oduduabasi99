        ...
        <div className="container">
          <div className="top-section">
            <div className="left">
              <p className="about__subheading">
                Hi, I am <span>Oduduabasi Isong</span>
              </p>
              <h2 className="about__heading">A freelance Web developer</h2>
              <div className="about__info">
                <PText>
                  I am from Akwa Ibom, Nigeria. A place of beauty and nature.
                  ...
                  <br /> <br />
                  I am the current Google Developers Student Club Lead in my
          ...
          <div className="about__info__items">
            <div className="about__info__item">
              ...
              <AboutInfoItem
                title="High School"
                items={['Ogu Community Secondary Commercial School']}
              />
              <AboutInfoItem title="Varsity" items={['Obong University']} />
            </div>
            <div className="about__info__item">
              ...
              <AboutInfoItem
                title="BackEnd"
                items={['Node', 'Express', 'PHP', 'MoongoDB', 'MySQL']}
              />
              <AboutInfoItem title="Design" items={['CorelDraw']} />
            </div>
          </div>
        </div>
        <ContactBanner />
